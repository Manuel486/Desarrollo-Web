package com.manuel.springboot.jpa.springbootjpa.repositories;

import com.manuel.springboot.jpa.springbootjpa.dto.PersonDto;
import com.manuel.springboot.jpa.springbootjpa.entities.Person;
...
public interface PersonRepository extends CrudRepository<Person, Long> {
    ...
    @Query("select new com.manuel.springboot.jpa.springbootjpa.dto.PersonDto(p.name, p.lastname) from Person p")
