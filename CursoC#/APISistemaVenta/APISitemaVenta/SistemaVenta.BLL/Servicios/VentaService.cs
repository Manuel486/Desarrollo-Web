    ...
    public class VentaService: IVentaService
    {
        ...
        public async Task<List<VentaDTO>> Historial(string buscarPor, string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                if(buscarPor == "fecha")
                {
                    DateTime fech_Inicio = DateTime.ParseExact(fechaInicio,"dd/MM/yyyy", new CultureInfo("en-PE")); 
                    DateTime fech_Fin = DateTime.ParseExact(fechaFin,"dd/MM/yyyy", new CultureInfo("en-PE"));
        ...
        public async Task<List<ReporteDTO>> Rerporte(string fechaInicio, string fechaFin)
        {
